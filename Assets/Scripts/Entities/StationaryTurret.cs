...
public class StationaryTurret : MonoBehaviour, IDamagable
{
    ...
    {
        turretHead.up = new Vector2(other.transform.position.x - turretHead.transform.position.x, other.transform.position.y - turretHead.transform.position.y) * -1.0f;
        //turretHead.LookAt(other.transform.position);
